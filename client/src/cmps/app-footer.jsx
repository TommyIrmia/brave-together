    ...
    <footer>
        <div className="links-container">
            <a href="https://www.facebook.com/BraveTogether2018" title="facebook">
                <FacebookIcon className='social-media-icon' style={{ fill: '#d6d6d6', width: '20px', margin: '0 5px 0 0' }} />
            </a>
            <a href='https://www.instagram.com/brave_together_insta/' title="instagram">
                <InstagramIcon className='social-media-icon' style={{ fill: '#d6d6d6', width: '20px', margin: '0 5px 0 0' }} />
            </a>
            <a href="https://www.youtube.com/channel/UCHry9px4UrXGZWgptKYm0EQ" title="youtube">
                <YoutubeIcon className='social-media-icon' style={{ fill: '#d6d6d6', width: '20px', margin: '0 5px 0 0' }} />
            </a>
            <a href="https://www.linkedin.com/company/brave-together-%D7%9E%D7%A6%D7%A2%D7%93-%D7%94%D7%92%D7%91%D7%95%D7%A8%D7%94/" title="linkdin">
                <LinkdinIcon className='social-media-icon' style={{ fill: '#d6d6d6', width: '20px', margin: '0 5px 0 0' }} />
            </a>
            <a href="https://github.com/gallib2/brave-together" title="github">
                <GithubIcon className='social-media-icon' style={{ fill: '#d6d6d6', width: '20px', margin: '0 5px 0 0' }} />
            </a>
        </div>
    </footer>
