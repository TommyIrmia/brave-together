    ...
    <section className="template-edit-container">
      ...
      <div className="canvas-container" ref={containerRef}>
        ...
        <div className="btns-container-2">
          ...
          <button className="share-btn" onClick={onToggleShareModal}>
            שתף
          </button>
        </div>
      </div>
      ...
      <section className="tool-bar-container">
        <OptionsContainer options={selectedOption.subTypes} setOption={setSelectedOption}>
          <DynamicOptions selectedOption={selectedOption} options={selectedOption.subTypes || null} template={template} setTemplate={setTemplate} />
        </OptionsContainer>
